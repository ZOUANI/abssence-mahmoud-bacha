...
import com.gestion.absenteisme.etudiants.ejb.service.SeanceFacade;
...
public class SeanceController implements Serializable {
    ...
    @EJB
    private com.gestion.absenteisme.etudiants.ejb.service.SeanceFacade ejbFacade;
    ...
    public Seance getSeance(java.lang.Integer id) {
    ...
    public static class SeanceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getSeance(getKey(value));
        }
