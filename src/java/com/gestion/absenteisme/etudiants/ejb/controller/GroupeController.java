...
import com.gestion.absenteisme.etudiants.ejb.entity.Groupe;
...
import com.gestion.absenteisme.etudiants.ejb.service.GroupeFacade;
...
public class GroupeController implements Serializable {
    ...
    @EJB
    private com.gestion.absenteisme.etudiants.ejb.service.GroupeFacade ejbFacade;
    ...
    public Groupe getGroupe(java.lang.Integer id) {
